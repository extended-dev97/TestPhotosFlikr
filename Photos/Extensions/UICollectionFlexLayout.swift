...
@objc public protocol UICollectionViewDelegateFlexLayout: UICollectionViewDelegate {
    ...
    @objc optional func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewFlexLayout, horizontalSpacingBetweenSectionAt section: Int, and nextSection: Int) -> CGFloat
